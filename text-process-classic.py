...
def generate_text_binary(parseFileExe, sourceFile, targetFile):
	import subprocess

	with open(targetFile, 'wb') as f:
		subprocess.call([parseFileExe, sourceFile, "--to-stdout"], stdout = f)
		...
		for entry in entryList:
			...
			if hasParser:
				if not os.path.exists(dataFileName) or textNeedsUpdate:
					generate_text_binary(parserExePath, textFileName, dataFileName)
